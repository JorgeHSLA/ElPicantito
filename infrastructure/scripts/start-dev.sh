...
# Ejecutar desde la raíz del proyecto: ./infrastructure/scripts/start-dev.sh
...
if command -v gnome-terminal >/dev/null 2>&1; then
    ...
    echo "⚠️  No se pudo abrir terminal para Backend. Ejecuta manualmente:"
...
if command -v gnome-terminal >/dev/null 2>&1; then
    ...
    echo "⚠️  No se pudo abrir terminal para Frontend. Ejecuta manualmente:"
...
if command -v gnome-terminal >/dev/null 2>&1; then
    ...
    echo "⚠️  No se pudo abrir terminal para Chatbot. Ejecuta manualmente:"
